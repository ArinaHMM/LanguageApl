...
// class ChatsPage1 extends StatefulWidget {
//   const ChatsPage1({super.key});

//   @override
//   State<ChatsPage1> createState() => _ChatsPage1State();
// }

// class _ChatsPage1State extends State<ChatsPage1> {
...
//                 Navigator.popAndPushNamed(context, '/prof1'); // Возврат на предыдущую страницу
//               },
//       ),
//       ),
//       body: Stack(
