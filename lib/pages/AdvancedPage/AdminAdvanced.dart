...
class AddAdvancedLessonPage extends StatefulWidget {
  @override
  _AddAdvancedLessonPageState createState() =>  _AddAdvancedLessonPageState ();
}

class _AddAdvancedLessonPageState extends State<AddAdvancedLessonPage> {
  ...
  void _saveUpperLesson() async {
    if (_lessonNameController.text.isNotEmpty &&
      ...
      DocumentReference newUpperLessonRef =
          await FirebaseFirestore.instance.collection('advancedlessons').add({
