...
class AddUpperLessonPage extends StatefulWidget {
  @override
  _AddUpperLessonPageState createState() => _AddUpperLessonPageState();
}

class _AddUpperLessonPageState extends State<AddUpperLessonPage> {
  ...
  void _saveUpperLesson() async {
    if (_lessonNameController.text.isNotEmpty &&
      ...
      DocumentReference newUpperLessonRef =
          await FirebaseFirestore.instance.collection('upperlessons').add({
