...
class UpperLessonPage extends StatefulWidget {
  ...
  @override
  _UpperLessonPageState createState() => _UpperLessonPageState();
}

class _UpperLessonPageState extends State<UpperLessonPage> {
  List<dynamic> words = [];
  int currentIndex = 0;
  ...
  Future<void> updateUserProgress(String lessonId, int newProgress) async {
    ...
    if (currentUser != null) {
      ...
      await userDoc.update({
        'progressel.$lessonId': newProgress,
      });
    }
  }
  ...
  Future<void> _checkAndUpdateUserLevel() async {
    ...
    if (currentUser != null) {
      ...
      if (userSnapshot.exists) {
        ...
        print('User Progress: ${userData['progressel']}');
        ...
        if (currentLevel == 'Elementary') {
          ...
          if (allLessonsCompleted) {
            await userDoc.update({'language': 'Upper Intermediate'});
