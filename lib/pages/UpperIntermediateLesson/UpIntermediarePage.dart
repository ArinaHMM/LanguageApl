...
class UpperInterLessonPage extends StatefulWidget {
...
class _UpperLessonPageState extends State<UpperInterLessonPage> {
  List<dynamic> words = [];
  int currentIndex = 0;
  ...
  Future<void> updateUserProgress(String lessonId, int newProgress) async {
    ...
    if (currentUser != null) {
      ...
      await userDoc.update({
        'progressint.$lessonId': newProgress,
      });
    }
  }
  ...
  Future<void> _checkAndUpdateUserLevel() async {
    ...
    if (currentUser != null) {
      ...
      if (userSnapshot.exists) {
        ...
        final currentLevel = userData['language'] ?? 'Intermediate';
        ...
        if (currentLevel == 'Elementary') {
          ...
          bool allLessonsCompleted =
            ...
            final lessonProgress = userData['progressint'][doc.id] ?? 0;
