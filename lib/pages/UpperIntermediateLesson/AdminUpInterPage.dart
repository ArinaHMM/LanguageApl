...
class AddUpperInterLessonPageState extends StatefulWidget {
  @override
  _AddUpperInterLessonPageState createState() => _AddUpperInterLessonPageState();
}

class _AddUpperInterLessonPageState extends State<AddUpperInterLessonPageState> {
  ...
  void _saveUpperLesson() async {
    if (_lessonNameController.text.isNotEmpty &&
      ...
      DocumentReference newUpperLessonRef =
          await FirebaseFirestore.instance.collection('upperinterlessons').add({
