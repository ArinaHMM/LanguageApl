...
class LessonPage1 extends StatefulWidget {
  final String lessonId;
  final String lessonLevel; // Уровень урока (например, Beginner, Intermediate)
  ...
  @override
  _LessonPage1State createState() => _LessonPage1State();
}

class _LessonPage1State extends State<LessonPage1> {
  List<dynamic> words = [];
  int currentIndex = 0;
  ...
  Future<void> _checkAndUpdateUserLevel() async {
    ...
    if (currentUser != null) {
      ...
      if (userSnapshot.exists) {
        ...
        final currentLevel = userData['language'] ?? 'Beginner';
        ...
        if (currentLevel == 'Beginner') {
          ...
          if (allLessonsCompleted) {
            await userDoc.update({'language': 'Elementary'});
